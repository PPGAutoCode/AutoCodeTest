...
namespace ProjectName.Interfaces
{
    ...
    public interface IFAQService
    {
        ...
        /// <returns>A string representing the identifier of the newly created FAQ entry.</returns>
        ...
        /// <returns>A string representing the identifier of the updated FAQ entry.</returns>
        Task<string> UpdateFAQ(UpdateFAQDto updateFAQDto);

        /// <summary>
        /// Deletes a specific FAQ entry based on the provided request data.
        /// </summary>
        /// <param name="deleteFAQDto">The data transfer object containing the information to identify the FAQ entry to be deleted.</param>
